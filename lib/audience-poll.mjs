...
export class AudiencePoll {
 constructor({origin=process.env.LECTURE_POLL_ORIGIN,room=process.env.LECTURE_POLL_ROOM || "webdev-2026",token=process.env.LECTURE_POLL_TOKEN,fetcher=fetch,sessionId=randomUUID()}={}) {
