...
export class AudiencePoll {
 ...
 state(){return {pollId:this.pollId,decisions:this.decisions(),presets:lecturePolls,configured:!!this.origin && !!this.token,config:this.config,snapshot:this.snapshot,frozen:this.frozen,busy:this.busy,error:this.error,joinUrl:this.origin ? this.origin+"/rooms/"+this.room : ""};}
 select(id){
