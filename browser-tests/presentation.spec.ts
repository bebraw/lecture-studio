...
test("Obsidian snapshot loads privately and detours return without changing the definition",async({browser})=>{
 ...
 const definition={version:1,title:"Independent presentation",start:"title",theme:{},steps:[{id:"title",type:"title",title:"Snapshot title",next:"question"},{id:"question",type:"question",title:"Audience question",related:["aside"]},{id:"aside",type:"material",title:"Definition detour",body:"A useful definition.",notes:"PRIVATE FACILITATION"}]};
 ...
 try{
   ...
   await expect(desk.locator("#presentation-detail-content #model")).toHaveCount(0);
