...
export function buildLabel(build) {
 const labels = { working: build.activity || "Working", waiting: "Build paused", failed: "Build needs attention", ready: build.startedAt ? "Finished" : "Ready · nothing sent", disconnected: "Codex disconnected", connecting: "Connecting Codex" };
...
export async function api(token, path, value) {
